...
let auth = {
    url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/auth/login`,
    url2: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/auth/register`,
    email: "",
    password: "",
    token: "",
    ...
    login: function() {
        mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            ...
            return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/invoices");
        });
    },
    register: function() {
        mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
                ...
                auth.token = result.data.token;
                return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/home");
            });
        });
    }
};
...
let deliveries = {
    ...
    save: function() {
        ...
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            ...
            deliveries.product = {};
            deliveries.current = {};
            mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/deliveries");
        });
    }
};
...
let invoicesModel = {
    url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/invoices`,
    apiKey: _vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey,
    invoices: [],
    invoiceAdd: {},
    getInvoices: function() {
        mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            url: `${invoicesModel.url}?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`,
            method: "GET",
            headers: {
    ...
    createInvoice: function(e, t) {
        invoicesModel.invoiceAdd.api_key = _vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey;
...
let orders = {
    url: _vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl,
    apiKey: _vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey,
...
const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlfa2V5Ijo"+
"iNzllYzVhMDFhNTA3YjEwOTBhNjIxNjZhNzFlZTJlYTEiLCJlbWFpbCI6InRlc3RAd"+
"GVzdC5zZSIsImlhdCI6MTYxOTE1ODY3NiwiZXhwIjoxNjE5MjQ1MDc2fQ.0--GkgP4"+
"aFMzkQTc8XEBvNEEGNXgDhueC-Vj0d2vfc4";
...
/* harmony import */ var _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/deliveries.js */ "./www/js/models/deliveries.js");
...
let form = {
    oninit: _models_products_js__WEBPACK_IMPORTED_MODULE_1__.products.loadList,
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("form.login-form", {
            onsubmit: function(event) {
                event.preventDefault();
                _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.save();
            } }, [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Amount:"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("input.input[type=number][placeholder=Amount]", {
                oninput: function (e) {
                    _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.amount = e.target.value;
                },
                value: _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.amount
            }),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Date:"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("input.input[type=date][placeholder=Date]", {
                oninput: function (e) {
                    _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.delivery_date = e.target.value;
                },
                value: _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.delivery_date
            }),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Comment:"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("input.input[type=textarea][placeholder=Comment]", {
                oninput: function (e) {
                    _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.comment = e.target.value;
                },
                value: _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.comment
            }),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Item:"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("select.input", {
                onchange: function (e) {
                    console.log(e.target.value.split(","));
                    _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.product_id = e.target.value.split(",")[0];
                    _models_deliveries_js__WEBPACK_IMPORTED_MODULE_2__.deliveries.current.product_name = e.target.value.split(",")[1];
                }
            },  _models_products_js__WEBPACK_IMPORTED_MODULE_1__.products.list.map(function(product) {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()("option", {value: [product.id, product.name]},
                    product.id + " - " + product.name);
            })),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Save].button.form-button", "Spara")
        ]);
    }
};
...
let home = {
    view: function() {
        return [ mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Home"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h3", "Welcome Home.")];
    }
};
...
let inForm = {
    oninit: _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.loadList,
    view: function () {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Ny leverans"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form.login-form", {
                onsubmit: function (event) {
                    event.preventDefault();
                    //console.log(orders.current);
                    //console.log(orders.total);
                    groupVisible = false;
                    _models_invoices_js__WEBPACK_IMPORTED_MODULE_2__.invoicesModel.createInvoice(_models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.id, _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.total);
                    _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.update();
                }
            }, [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Orders: "),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("select.input", {
                    onchange: function (e) {
                        //console.log(e.target.value.split(","));
                        _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.save(e.target.value.split(",")[0]);
                        groupVisible = true;
                    }
                },  _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.list.map(function(order) {
                    return mithril__WEBPACK_IMPORTED_MODULE_0___default()("option", {value: [order.id, order.name]},
                        order.name);
                })),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Submit].button.form-button", "Submit")
            ]),
            groupVisible ? mithril__WEBPACK_IMPORTED_MODULE_0___default().fragment ({oninit: log}, [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.invoice",
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("tr",
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.id),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.name),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.address),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.zip),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.city),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.country),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current.status)
                    )
                ),

                mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.deliveries", _models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current_items.map(function (order) {
                    return mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.invoice", [
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("tr",
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", order.name),
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", order.article_number),
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Amount: ", order.amount),
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", order.description),
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Price: ", order.price),
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Stock: ", order.stock),
                            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", orderSpecifiers(JSON.parse(order.specifiers)))
                        )
...
function orderSpecifiers(e) {
    ...
    if (e.length != null && e.width != null) {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Length: ", e.length),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Width: ", e.width)
        ];
    }
    return mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Diameter: ", e.diameter);
...
let invoiceTable = {
    view: function () {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Inleverans"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("table.table.table-striped.table-stacked",
                _models_invoices_js__WEBPACK_IMPORTED_MODULE_1__.invoicesModel.invoices.map(function(invoice) {
                    return mithril__WEBPACK_IMPORTED_MODULE_0___default()("thead.invoice", [
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("td[data-title='Namn']", invoice.name),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("td[data-title='Pris']", invoice.total_price),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("td[data-title='Fakturadatum']", invoice.creation_date),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("td[data-title='Förfallodatum']", invoice.due_date)
                    ]);
                })),

            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {
                selector: "button",
                href: "/inform",
                class: "form-button"
            }, "Add Invoice")
...
let noData = {
    view: function() {
        return [mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Det har inga fakturor!"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {
                selector: "button",
                href: "/inform",
                class: "form-button"
...
let invoices = {
    oninit: _models_invoices_js__WEBPACK_IMPORTED_MODULE_1__.invoicesModel.getInvoices,
    view: function () {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Fakturor"),
            _models_invoices_js__WEBPACK_IMPORTED_MODULE_1__.invoicesModel.invoices.length > 0 ? mithril__WEBPACK_IMPORTED_MODULE_0___default()(invoiceTable) : mithril__WEBPACK_IMPORTED_MODULE_0___default()(noData)
        ];
    }
};
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/deliveries.js */ "./www/js/models/deliveries.js");
...
let list = {
    oninit: _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__.deliveries.getDeliveries,

    view: function() {
        return [ mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Inleverans"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {
                selector: "button",
                href: "/form",
                class: "form-button"
            }, "Add delivery"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.deliveries", _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__.deliveries.currentDeliveries.map(function (delivery) {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.invoice", [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", delivery.product_name + " - " + delivery.amount + "st"),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", delivery.delivery_date),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", delivery.comment)
                    //m("button", {onclick: function() {}}, "Form")
                ]);
            }))
        ];
...
let login = {
    view: function () {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Log In"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form.login-form", {
                onsubmit: function (event) {
                    event.preventDefault();
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("lavel.input-label", "E-post"),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("lavel.input-label", "Password"),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Log in].login-button", "Log In"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {
                    selector: "button",
                    href: "/register",
                    class: "form-button"
    ...
    view: function(vnode) {
        if (_models_auth_js__WEBPACK_IMPORTED_MODULE_1__.auth.token) {
            return [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("nav.top-nav",
                    { textContent: ""},
                    [
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", { href: "#!/" }, "Home"),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", { href: "#!/deliveries" }, "Deliveries"),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", { href: "#!/invoices" }, "Invoices")
                    ]),
        ...
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("nav.top-nav",
                ...
                [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", { href: "#!/" }, "Home"),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", { href: "#!/login" }, "Log In")
                ]),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", vnode.children)
        ];
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "nohome": () => (/* binding */ nohome)
/* harmony export */ });
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
...
let nohome = {
    view: function() {
        return [ mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Home"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h3", "You are currently not logged in.")];
    }
};
    ...
    view: function () {
        return [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Register].button", "Register")
            ])
        ];
    }
};
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _views_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/list */ "./www/js/views/list.js");
/* harmony import */ var _views_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/menu */ "./www/js/views/menu.js");
/* harmony import */ var _views_home__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/home */ "./www/js/views/home.js");
/* harmony import */ var _views_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/form */ "./www/js/views/form.js");
/* harmony import */ var _views_invoices_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/invoices.js */ "./www/js/views/invoices.js");
/* harmony import */ var _views_login_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/login.js */ "./www/js/views/login.js");
/* harmony import */ var _views_invoiceForm_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/invoiceForm.js */ "./www/js/views/invoiceForm.js");
/* harmony import */ var _views_register_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/register.js */ "./www/js/views/register.js");
/* harmony import */ var _views_nohome_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/nohome.js */ "./www/js/views/nohome.js");
/* harmony import */ var _models_auth_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./models/auth.js */ "./www/js/models/auth.js");
...
mithril__WEBPACK_IMPORTED_MODULE_0___default().route(document.body, "/", {
    "/": {
        onmatch: function() {
            if (_models_auth_js__WEBPACK_IMPORTED_MODULE_10__.auth.token) {
                return _views_home__WEBPACK_IMPORTED_MODULE_3__.home;
            }

            return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/home");
        },
        render: function (vnode) {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu__WEBPACK_IMPORTED_MODULE_2__.menu, vnode);
        }
    },
    "/home": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu__WEBPACK_IMPORTED_MODULE_2__.menu, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_nohome_js__WEBPACK_IMPORTED_MODULE_9__.nohome));
        }
    },
    "/deliveries": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu__WEBPACK_IMPORTED_MODULE_2__.menu, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_list__WEBPACK_IMPORTED_MODULE_1__.list));
        }
    },
    "/form": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu__WEBPACK_IMPORTED_MODULE_2__.menu, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_form__WEBPACK_IMPORTED_MODULE_4__.form));
        }
    },
    "/inform": {
        onmatch: function() {
            if (_models_auth_js__WEBPACK_IMPORTED_MODULE_10__.auth.token) {
                return _views_invoiceForm_js__WEBPACK_IMPORTED_MODULE_7__.inForm;
            }
    ...
    "/invoices": {
        onmatch: function() {
            if (_models_auth_js__WEBPACK_IMPORTED_MODULE_10__.auth.token) {
                return _views_invoices_js__WEBPACK_IMPORTED_MODULE_5__.invoices;
            }
    ...
    "/register": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu__WEBPACK_IMPORTED_MODULE_2__.menu, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_register_js__WEBPACK_IMPORTED_MODULE_8__.register));
        }
    },
    "/login": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu__WEBPACK_IMPORTED_MODULE_2__.menu, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_login_js__WEBPACK_IMPORTED_MODULE_6__.login));
        }
    }
});
